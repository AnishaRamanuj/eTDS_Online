<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="XL26Q.aspx.cs" Inherits="Admin_ExcelValidation" %>
    ...
    <table id="Table1" width="100%" height="600px" cellpadding="5" cellspacing="0">
        <tr height="5px" valign="top">
            <td class="cssPageTitle">
                <asp:Label ID="Label1" runat="server" Text="Form 26Q Voucher Excel Import"></asp:Label>
            </td>
        </tr>
        <tr height="5px">
            <td>
        ...
        <tr height="5px">
            <td>
                ...
                <a style="padding-right: 50px;" href="../XL File/26Q_2223_Blank.xlsx">
        ...
        <tr>
            <td style="vertical-align: top; padding-top: 20px;">
                <div style="width: 100%; margin: auto; white-space: nowrap;  overflow-y: auto;" id="divData">
                </div>
            </td>
        </tr>
            ...
            $.ajax(
                {
                    ...
                    url: '../Handler/ExcelFileUpload.ashx', //web service
                    type: 'POST',
                    complete: function () {
                        //on complete event    
                    ...
                    error: function (e) {
                        ...
                        $("#file").val('');
                        ShowErrorWindow(e.responseText);
                        $(".MastermodalBackground2").hide();
                        return false;
                    },
                    ///Form data
        ...
        function BindData(ds) {
            ...
            for (var i = 0; i < dt.length; i++) {
               ...
               // tbl_html_val += "<td style='word-wrap: break-word; width:220px;'>" + dt[i]["Name_Of_Deductee"] + "</td>"
                ...
                //tbl_html_val += BindRow_Section_Code(dt[i]["Section_Code"], 1, "Section_Code_" + i, ds); ////  "<td>" + dt[i]["Section_Code"] + "</td>"
                tbl_html_val += BindRow_Section(dt[i]["Section_Description"], 1, "Section_Description_" + i, ds); ////"<td>" + dt[i]["Section_Description"] + "</td>"
                ...
                if (errorNumber.indexOf("3") > -1) {
                    ...
                    tbl_html_val += BindRow(dt[i]["Total_Tax_Deducted"], 0, "Total_Tax_Deducted_" + i);
                }
                ...
                if (dt[i]["Certificate_number_for_Lower_NonDeduction"] != '') {
                    ...
                    tbl_html_val += BindRow(dt[i]["Certificate_number_for_Lower_NonDeduction"], 0, "Certificate_number_for_Lower_NonDeduction_" + i);
                }
            ...
            //$("#divData").css("height", size.height - 320);
            //$("body").css("height", size.height - 320);
            $(".MastermodalBackground2").hide();
            fnBlur();
        }
            ...
            $("#divData tr").each(function (j, v) {
                if (j > 0) {
                    ...
                    data = {
                        ...
                        // Payment_CreditDate: $(this).find("#Payment_CreditDate_" + i).val(),
