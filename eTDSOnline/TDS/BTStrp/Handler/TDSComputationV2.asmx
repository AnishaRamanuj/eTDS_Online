...
public class TDSComputationV2 : System.Web.Services.WebService
{
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString2, CommandType.StoredProcedure, "usp_BootStrap_EmployeeComputionSummaryV2", param))
            {
                while (drrr.Read())
                {
                    LTDS.Add(new tblTDSComputationSummary()
                    {
                        ...
                        I115BAC = Comm.GetValue<int>(drrr["I115BAC"].ToString()),
                        Total_Earnings = Comm.GetValue<double>(drrr["Total_Earnings"].ToString()),
                        GrossPerks_B = Comm.GetValue<double>(drrr["GrossPerks_B"].ToString()),
                        GrossProfits_C = Comm.GetValue<double>(drrr["GrossProfits_C"].ToString()),
                        GrossTotal_D = Comm.GetValue<double>(drrr["GrossTotal_D"].ToString()),
                        PreSal = Comm.GetValue<double>(drrr["PreSal"].ToString()),
                        StandardDeductions = Comm.GetValue<double>(drrr["StandardDeductions"].ToString()),
                        Entertainment = Comm.GetValue<double>(drrr["Entertainment"].ToString()),
                        PTax = Comm.GetValue<double>(drrr["PTax"].ToString()),
                        IntHouseLoan = Comm.GetValue<double>(drrr["IntHouseLoan"].ToString()),
                        OtherIncome = Comm.GetValue<double>(drrr["OtherIncome"].ToString()),
                        Rebate80C = Comm.GetValue<double>(drrr["Rebate80C"].ToString()),
                        Rebate80CCC = Comm.GetValue<double>(drrr["Rebate80CCC"].ToString()),
                        Rebate80CCD = Comm.GetValue<double>(drrr["Rebate80CCD"].ToString()),
                        Rebate80CCD1B = Comm.GetValue<double>(drrr["Rebate80CCD1B"].ToString()),
                        Rebate80CCD2 = Comm.GetValue<double>(drrr["Rebate80CCD2"].ToString()),
                        Rebate88D = Comm.GetValue<double>(drrr["Rebate88D"].ToString()),
                        Rebate80G = Comm.GetValue<double>(drrr["Rebate80G"].ToString()),
                        Rebate80E = Comm.GetValue<double>(drrr["Rebate80E"].ToString()),
                        Rebate80EE = Comm.GetValue<double>(drrr["Rebate80EE"].ToString()),
                        Rebate80TTA = Comm.GetValue<double>(drrr["Rebate80TTA"].ToString()),
                        //  Rebate80Others = Comm.GetValue<double>(drrr["Rebate80Others"].ToString()),
                        Rebate89 = Comm.GetValue<double>(drrr["Rebate89"].ToString()),
                        PreTds = Comm.GetValue<double>(drrr["PreTds"].ToString())
                    });
                }
    ...
    [System.Web.Services.WebMethod(EnableSession = true)]
    public string UpdateEmployeeInfo(int eid, string fieldName, string value)
    {
        DALCommonLib objComm = new DALCommonLib();
        Functions4evr Comm = new Functions4evr();
        List<tblTDSComputationSummary> obj = new List<tblTDSComputationSummary>();
        ...
        try
        {
            // Update the parameter array to include @fieldName
            SqlParameter[] param = new SqlParameter[4];
            param[0] = new SqlParameter("@eid", eid);
            param[1] = new SqlParameter("@fieldName", fieldName); // Add this line
            param[2] = new SqlParameter("@value", value);
            param[3] = new SqlParameter("@Company_ID", Session["companyid"]);

            if (fieldName == "Email_ID" || fieldName == "PanNumber")
            {
                using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString, CommandType.StoredProcedure, "usp_Bootstrap_Update_Employee_Info", param))
                {
                    while (drrr.Read())
                    {
                        var employeeRecord = new tblTDSComputationSummary()
                        {
                            Employee_ID = Comm.GetValue<int>(drrr["Employee_ID"].ToString()) // Always include Employee_ID
                        };

                        // Dynamically set the field based on the fieldName
                        switch (fieldName)
                        {
                            case "EmailAdd":
                                employeeRecord.EmailAdd = value;
                                break;

                            case "PanNumber":
                                employeeRecord.PanNumber = value;
                                break;
                        }
                        obj.Add(employeeRecord);
                    }
                }
            }
            else
            {
                using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString2, CommandType.StoredProcedure, "usp_Bootstrap_Update_Employee_TDS_Computation_Info", param))
                {
                    while (drrr.Read())
                    {
                        var employeeRecord = new tblTDSComputationSummary()
                        ...
                        {
                            case "I115BAC":
                                employeeRecord.I115BAC = Comm.GetValue<int>(value);
                                break;

                            case "Total_Earnings":
                                employeeRecord.Total_Earnings = Comm.GetValue<double>(value);
                                break;

                            case "GrossPerks_B":
                                employeeRecord.GrossPerks_B = Comm.GetValue<double>(value);
                                break;


                            case "GrossProfits_C":
                                employeeRecord.GrossProfits_C = Comm.GetValue<double>(value);
                                break;

                            case "GrossTotal_D":
                                employeeRecord.GrossTotal_D = Comm.GetValue<double>(value);
                                break;

                            case "PreSal":
                                employeeRecord.PreSal = Comm.GetValue<double>(value);
                                break;

                            case "StandardDeductions":
                                employeeRecord.StandardDeductions = Comm.GetValue<double>(value);
                                break;

                            case "Entertainment":
                                employeeRecord.Entertainment = Comm.GetValue<double>(value);
                                break;

                            case "PTax":
                                employeeRecord.PTax = Comm.GetValue<double>(value);
                                break;

                            case "IntHouseLoan":
                                employeeRecord.IntHouseLoan = Comm.GetValue<double>(value);
                                break;

                            case "OtherIncome":
                                employeeRecord.OtherIncome = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80C":
                                employeeRecord.Rebate80C = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80CCC":
                                employeeRecord.Rebate80CCC = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80CCD":
                                employeeRecord.Rebate80CCD = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80CCD1B":
                                employeeRecord.Rebate80CCD1B = Comm.GetValue<double>(value);
                                break;


                            case "Rebate80CCD2":
                                employeeRecord.Rebate80CCD2 = Comm.GetValue<double>(value);
                                break;

                            case "Rebate88D":
                                employeeRecord.Rebate88D = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80G":
                                employeeRecord.Rebate80G = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80E":
                                employeeRecord.Rebate80E = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80EE":
                                employeeRecord.Rebate80EE = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80TTA":
                                employeeRecord.Rebate80TTA = Comm.GetValue<double>(value);
                                break;

                            case "Rebate80Others":
                                employeeRecord.Rebate80Others = Comm.GetValue<double>(value);
                                break;

                            case "Rebate89":
                                employeeRecord.Rebate89 = Comm.GetValue<double>(value);
                                break;

                            case "PreTds":
                                employeeRecord.PreTds = Comm.GetValue<double>(value);
                                break;
                        }
                        obj.Add(employeeRecord);
                    }
    ...
    public string DeleteEmployee(int employeeId)
    {
        DALCommonLib objComm = new DALCommonLib();
        Functions4evr Comm = new Functions4evr();
        List<tbl_Employee_Master> obj_Employee = new List<tbl_Employee_Master>();
        try
        {
            SqlParameter[] param = new SqlParameter[2];
            ...
            using (SqlDataReader drrr = SqlHelper.ExecuteReader(objComm._cnnString2, CommandType.StoredProcedure, "usp_Bootstrap_Employee_delete", param))
            {
                while (drrr.Read())
                {
                    obj_Employee.Add(new tbl_Employee_Master()
                    {
                        Employee_ID = Comm.GetValue<int>(drrr["Employee_ID"].ToString()),
                    });
                }
        ...
        IEnumerable<tbl_Employee_Master> tbl = obj_Employee as IEnumerable<tbl_Employee_Master>;
        var obbbbb = tbl;
        return new JavaScriptSerializer().Serialize(tbl);
    }
