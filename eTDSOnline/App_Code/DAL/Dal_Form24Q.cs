...
namespace DataLayer
{
 public class Dal_Form24Q : DALCommon
    {
        CommonLibrary.CommonFunctions ErrorException = new CommonLibrary.CommonFunctions();
        public SqlDataReader DAL_getChallanDetails(objChallanDetails_24Q obj)
        {
            ...
            //return SqlHelper.ExecuteReader(_cnnString2, CommandType.StoredProcedure, "Usp_Bind_ChallanDetails_For_Annexure24Q", param);
            return SqlHelper.ExecuteReader(_cnnString2, CommandType.StoredProcedure, "Usp_Bind_ChallanDetails_For_Annexure24Q", param);
        }
