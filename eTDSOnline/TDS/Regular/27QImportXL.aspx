<%@ Page Title="" Language="C#" MasterPageFile="~/TDS/BTS_MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="27QImportXL.aspx.cs" Inherits="Import27QXL" %>
        ...
        $(document).ready(function () {
           ...
           // debugger;
            ...
            $("[id*=btnUpload]").click(function () {
                ...
                $.ajax({
                    url: '../Handler/Import27QXLHandler.ashx/ProcessRequest',
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h5>
                        <span class="font-weight-bold">27Q(NRI) - XL Import</span></h5>
                    </div>
                        <div class="col-sm-4">
            ...
            <div class="card-body" style="padding-top: 0px; padding-bottom: 0px;">
                     ...
                     <label class="col-lg-1 col-form-label"  >Step 1.</label>
                                <div class="col-sm-2" style="font-size: larger;">
                                    <select id="ddlForm" class="form-control form-control-border select select2-hidden-accessible">
                                        ...
                                        <option value="27Q" selected>27Q(NRI)</option>
                ...
                <div class="form-group row " style="padding-top:12px;" id="importconso">
                       ...
                       <label class="col-lg-1 col-form-label"  >Step 2.</label>
                                                        <div class="col-4">
                                                            <a href="../../Templates/27Q_Blank_XLSheet.xlsx">
