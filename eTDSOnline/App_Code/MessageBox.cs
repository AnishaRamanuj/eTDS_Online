...
public class MessageBox
{
    ...
    public static void InsertMessage(string ModuleName)
    {
        Show(ModuleName + " Inserted Sucessfully.");
    }

    public static void UpdateMessage(string ModuleName)
    {
        Show(ModuleName + " Updated Sucessfully.");
    }

    public static void ErrorMessage()
    {
        Show("Some Technical Issue.Please contact your Administrator.");
    }
    ...
    public static object Show(string v1, string v2, object oK, object none)
    {
