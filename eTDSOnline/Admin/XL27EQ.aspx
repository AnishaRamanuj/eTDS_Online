<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="XL27EQ.aspx.cs" Inherits="Admin_XL27EQ" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterPage" runat="Server">
    ...
    <table id="Table1" width="100%" height="600px" cellpadding="5" cellspacing="0">
        <tr height="5px" valign="top">
            <td class="cssPageTitle">
                <asp:Label ID="Label1" runat="server" Text="Form 27EQ Voucher Excel Import"></asp:Label>
            </td>
        </tr>
        <tr height="5px">
            <td>
        ...
        <tr height="5px">
            <td>
                ...
                <a style="padding-right: 50px;" href="../XL File/27EQ_2223_Blank.xlsx">
    ...
    <script type="text/javascript">
            ...
            $.ajax(
                {
                    ...
                    url: '../Handler/XL27EQ.ashx', //web service
                    type: 'POST',
                    complete: function () {
                        //on complete event    
        ...
        function BindData(ds) {
            ...
            for (var i = 0; i < dt.length; i++) {
                ...
                if (errorNumber.indexOf("2") > -1 || errorNumber.indexOf("6") > -1 || errorNumber.indexOf("5") > -1 || errorNumber.indexOf("7") > -1) {
                    tbl_html_val += BindRow_Reason(dt[i]["Reason_for_Non_deduction_Lower_Deduction"], 1, "Reason_for_Non_deduction_Lower_Deduction_" + i, ds);
                }
                else {

                    tbl_html_val += BindRow_Reason(dt[i]["Reason_for_Non_deduction_Lower_Deduction"], 0, "Reason_for_Non_deduction_Lower_Deduction_" + i, ds);
                }
        ...
        function BindRow_Reason(value, error, id, ds) {
            var htm = "";
            var dt = ds.Table3;
            ...
            for (var i = 0; i < dt.length; i++) {
                ...
                drp = drp + "<option value='" + dt[i]["Section_Name"] + "'>" + dt[i]["Section_Name"] + "</option>"
            }
            drp = drp + "</select>"
