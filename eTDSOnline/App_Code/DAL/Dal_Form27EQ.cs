...
namespace DataLayer
{
    public class Dal_Form27EQ : DALCommon
    {
        CommonLibrary.CommonFunctions ErrorException = new CommonLibrary.CommonFunctions();
        public SqlDataReader DAL_getChallanDetails(objChallanDetails obj)
        {
            ...
            return SqlHelper.ExecuteReader(_cnnString2, CommandType.StoredProcedure, "Usp_Bind_ChallanDetails_For_Annexure27EQ", param);
        }
    }
}
