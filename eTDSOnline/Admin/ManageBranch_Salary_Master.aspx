<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ManageBranch_Salary_Master.aspx.cs" Inherits="Forms._ManageBranch_Salary_Master" %>
                        ...
                        <fieldset class="login">
                            <asp:Table ID="tblBranchdf" runat="server" Width="100%" CellPadding="3" CellSpacing="0">
                                ...
                                <asp:TableRow runat="server" ID="TableRow1" Visible="true">
                                    <asp:TableCell>
                                        <asp:Label ID="Label2" runat="server" CssClass="cssLabel" Text="State"></asp:Label>
                                    </asp:TableCell>
                                    <asp:TableCell>
                                        <asp:DropDownList runat="server" ID="ddlState" CssClass="cssDropDownList">
                                        </asp:DropDownList>
