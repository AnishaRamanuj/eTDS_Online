<%@ Page Title="" Language="C#" MasterPageFile="~/TDS/BTS_MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="26QImportXL.aspx.cs" Inherits="Import26QXL" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("[id*=btnUpload]").click(function () {
                ...
                if ($("#file")[0].files.length==0) {
                    showDangerAlert("Please choose file to upload");
                    return;
                }
                Blockloadershow();
                ...
                $.ajax({
                    url: '../BTStrp/Handler/Import26QXLHandler.ashx/ProcessRequest',
                    type: 'POST',
                    data: formData,
                    cache: false,
                    contentType: false,
                    ...
                    success: function (data) {
                       ...
                       // debugger;
                        $("#file").val('');
                        if (data.isPass) {
                            showSuccessAlert(data.errorMessage);
                        }
                        else {
                            if (data.filePath) {
                                showDangerAlert('Excel file having some error in  records . check error file for more info');
                                window.open(data.filePath, '_blank');
                            }
                            else {
                                showDangerAlert(data.errorMessage);
                            }
                        }
                        Blockloaderhide();
                      //  BindData(data);
            ...
            $("[id*=btnDownloadBackup]").click(function () {
              ...
              //  var formData = new FormData();
                ...
                //debugger;
                $.ajax({
                    url: '../BTStrp/Handler/SalaryChallanDetails.asmx/ExportBackupExcel',
                    type: 'POST',
        ...
        function Deductee() {
            ...
            $.ajax({
                type: "POST",
                url: "../BTStrp/Handler/Correction.asmx/OpenDeducteePage",
        ...
        function eReturns() {
            ...
            $.ajax({
                type: "POST",
                url: "../BTStrp/Handler/Correction.asmx/CreateTxt",
        ...
        function updateFilleDate(dt) {
            $.ajax({
                type: "POST",
                url: "../BTStrp/Handler/Correction.asmx/updateDT",
                data: '{cid:' + Cid + ', dt:"' + dt + '"}',
                contentType: "application/json; charset=utf-8",
                success: function (msg) {
                    var myList = jQuery.parseJSON(response.d);
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h5>
                        <span class="font-weight-bold">26Q - XL Import</span></h5>
                    </div>
                        <div class="col-sm-4">
            ...
            <div class="card-body" style="padding-top: 0px; padding-bottom: 0px;">
                     ...
                     <label class="col-lg-1 col-form-label"  >Step 1.</label>
                                <div class="col-sm-2" style="font-size: larger;">
                                    <select id="ddlForm" class="form-control form-control-border select select2-hidden-accessible">
                                        <option value="26Q" selected>26Q</option> 
                ...
                <div class="form-group row " style="padding-top:12px;" id="importconso">
                       ...
                       <label class="col-lg-1 col-form-label"  >Step 2.</label>
                                                        <div class="col-4">
                                                            <a href="../../TDS/BTStrp/Templates/26Q_Blank_XLSheet.xlsx">
