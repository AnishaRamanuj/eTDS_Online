<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/MasterPage.master" CodeFile="ManageEducationCess_NSal_Master.aspx.cs" Inherits="Admin_ManageEducationCess_NSal_Master" %>
                    ...
                    <asp:TableCell runat="server" ID="tdGrid">
                        ...
                        <asp:DataGrid runat="server" ID="dgEducationcess_Master" AutoGenerateColumns="false" DataKeyField="Educationcess_ID"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="cess_Percent" HeaderText="Education Cess Percent">
                                    <HeaderStyle BorderColor="#dbdbdb" />
                                ...
                                <asp:BoundColumn DataField="HCess_Percent" HeaderText="H Edu Cess Percent">
                                    <HeaderStyle BorderColor="#dbdbdb" />
                                    <ItemStyle BorderColor="#dbdbdb" />
                                </asp:BoundColumn>
