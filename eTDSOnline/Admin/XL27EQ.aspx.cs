...
public partial class Admin_XL27EQ : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string UpdateRecords(List<XL27EQ> voucherDtls)
    {
        try
        {
            ...
            foreach (XL27EQ voucher in voucherDtls)
            {
            ...
            DataSet ds = SqlHelper.ExecuteDataset(dAL._cnnString2, CommandType.StoredProcedure, "Usp_27EQ_ExcelValidation", param);
