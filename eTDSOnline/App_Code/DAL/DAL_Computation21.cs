...
namespace DataLayer
{
  public  class DAL_Computation21 : DALCommon
    {
        ...
        public int DAL_SaveEmployeeComputation(Tbl_TDS_SaveComputation tobj)
        {
            try
            {
                ...
                dtdgPerquisites_Master.Columns.Remove("Perquisites_ID"); dtdgPerquisites_Master.Columns.Remove("Perquisites_Name");
                ...
                dtdgPerquisites_Master.Columns.Remove("Itax2"); dtdgPerquisites_Master.AcceptChanges();
                ///point 2
                ...
                objSqlParameter[62] = new SqlParameter("@dtdgPerquisites_Master", dtdgPerquisites_Master);
