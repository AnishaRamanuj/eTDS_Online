<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="xlHC.aspx.cs" Inherits="Admin_xlHC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MasterPage" Runat="Server">
        ...
        <tr height="5px">
            <td>
                ...
                <a style="padding-right: 50px;" href="../XL File/26Q_2122_Blank.xls">
    ...
    <script type="text/javascript" src="../customScript/common.js"></script>
            ...
            $.ajax(
                {
                    ...
                    url: '../Handler/xl.ashx', //web service
                    type: 'POST',
                    complete: function () {
                        //on complete event    
        ...
        //        tbl_html_val += BindRow(dt[i]["Amount_Paid_Credited"], 0, "Amount_Paid_Credited_" + i);
        ...
        //    }
        //    else {
        //        htm = "<td  style='width:120;'><input id='" + id + "' style='width:100px;' value='" + value + "' disabled /></td>";
        //    }
        //    return htm;
        //}
        ...
        //    var htm = "";
        //    var opt = "";
        //    opt = "Presc.Rt.~Lower Rt. Under Section 197 A~No Tax only for sec 194, 194A, 194EE, 193, 194DA, 192A, 194I(a), 194I(b) & 194D B~";
