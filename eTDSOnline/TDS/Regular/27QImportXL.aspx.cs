...
public partial class Import27QXL : System.Web.UI.Page
{
    ...
    public static string UpdateRecords(InputData inputData)
    {
        ...
        try
        {
            ...
            ds = SqlHelper.ExecuteDataset(objComm._cnnString2, CommandType.StoredProcedure, "DBP_ChallanExcelValidation", param);
            ...
            ds = SqlHelper.ExecuteDataset(objComm._cnnString2, CommandType.StoredProcedure, "DBP_ExcelValidationV3", param2);
            if (ds.Tables.Count > 2)
            {
                dsExport.Tables.Add(ds.Tables[0].Copy());
