<%@ WebHandler Language="C#" Class="XL27EQ" %>
...
public class XL27EQ : DataLayer.DALCommon, IHttpHandler, IRequiresSessionState {
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
                ...
                using (OleDbConnection excel_con = new OleDbConnection(conString))
                {
                    ...
                    foreach (DataRow dr in dtSchema.Rows)
                    {
                        ...
                        if (Sheet1 == "'Deductee Details$'")
                        {
                            ...
                            SqlHelper.ExecuteNonQuery(_cnnString2, CommandType.StoredProcedure, "Usp_27EQ_ExcelValidation", param);
            ...
            lbl10:
                ...
                ds = SqlHelper.ExecuteDataset(_cnnString2, CommandType.StoredProcedure, "Usp_27EQ_ExcelValidation", param);
