...
/// <summary>
/// Summary description for EntityTbl
/// </summary>
namespace EntityLibrary
{
    ...
    public class tbl_TDS_Computation
    {
        ...
        public List<tbl_Monthly_Salary_BreakUp> LSalaryForHRABreakup { get; set; }
    ...
    public class ChallanDetailsList
    {
        ...
        public string _Salary_Date { get; set; }
        public string _Tds_Deduction_Date { get; set; }
    ...
    public class tbl_Company_Mst
    {
        ...
        public string GSTN { get; set; }
        public List<tbl_FinancialYear> Lst_Fy { get; set; }
    ...
    public class tbl_Challan_Non_Salary
    {
        ...
        public List<objChallanDetails> LstChallan { get; set; }
    }
    ...
    public class tblTDSComputationSummary
    {
        ...
        public double Itax3 { get; set; }
        public double ChallanTDS { get; set; }
        ...
        public double Rebate80EE { get; set; }
        public double Rebate80TTA { get; set; }
        public double Rebate80Others { get; set; }
        public double Rebate89 { get; set; }
    ...
    public class tbl_Monthly_Salary_BreakUp
    {
        ...
        public float DAAmount { get; set; }

        public float HRAAmount { get; set; }

        public float HRRAmount { get; set; }
    }
    ...
    public class tbl_Slabs
    {
        public int? Company_ID { get; set; }
        public List<tbl_Incometax_Master> IncomeTaxMaster { get; set; }

        public List<tblEmployeeTDSReletatedOtherDetails> LtblEmployeeTDSReletatedOtherDetails { get; set; }

        public List<tbl_Incometax_Master_Multi> IBacTax { get; set; }

        public List<tbl_Rebate_Limits> Rebate_Limits { get; set; }

        public List<tbl_Surcharge_Slab> SurchargeSlab { get; set; }
    ...
    public class tbl_VoucherDropDowns
    {
        ...
        public List<Correction_Remiitance> list_Correction_Remiitance { get; set; }
    ...
    public class tbl_Dashboard
    {
        ...
        public double VouchersOrDeductions { get; set; }

        public double TaxDeducted { get; set; }

        public double ChallansOrTaxDeposited { get; set; }

        public double Diffrence { get; set; }

        public double ErrorInReturn { get; set; }
    ...
    public class tbl_BankMaster
    {
        ...
        public float BidBSRCode { get; set; }
    }
    ...
    public class Corr_Challan_List
    {
        public int Line_No { get; set; }
        public int CDRecNo { get; set; }
        public string Bank_Challan_no { get; set; }
        public int CountDed { get; set; }
        public string Bank_BSRCode { get; set; }
        public string Form { get; set; }
        public string Qua { get; set; }
        public string Challan_Date { get; set; }
        ...
        public double Interest { get; set; }
        public double Others { get; set; }
        public double Total_Deposit_Amt { get; set; }
        public double Total_Deductee_Deposit { get; set; }
        public double Late_fee { get; set; }
        public double Deductee_Total { get; set; }
    ...
    public class Corr_Details
    {
        ...
        public string Bank_Challan_no { get; set; }
        public string Tan { get; set; }
        public string FDown { get; set; }
        public string TotalChl { get; set; }
        public string TotalChlAmt { get; set; }
        public string FImpDT { get; set; }
        public string TotalDED { get; set; }
        public string TotalDedAmt { get; set; }
        public string CompChange { get; set; }
        public string CntDedEdit { get; set; }
        public string CntDedAdd { get; set; }
        public string CntPAN { get; set; }

        public string CSuccess { get; set; }
        public string CSuccessFVU { get; set; }
        public string CError { get; set; }
        public List<Correction_Obj> list_Cordet { get; set; }
    }

    public class Correction_Obj
    {
        public int Srno { get; set; }
        public int Compid { get; set; }
        public string quarter { get; set; }
        ...
        public string Tel { get; set; }
        public string Nri_Identification { get; set; }
        ...
        public string Deduction_DT { get; set; }
        public string CSuccess { get; set; }
        public string CSuccessFVU { get; set; }
        public string CError { get; set; }
        public List<Corr_Challan_List> list_Challan { get; set; }
    }


    public class Correction_Grd
    {
        public int Srno { get; set; }
        public string Form { get; set; }
        public string CNAME { get; set; }
        public int Compid { get; set; }
        public string ImportDT { get; set; }
        public string Qtr { get; set; }
        public string TAN { get; set; }
        ...
        public int correctionid { get; set; }
        public int Deductee { get; set; }
        public int PAN { get; set; }
        public int Company { get; set; }
        public int Computation { get; set; }
    }

    public class Correction_Remiitance
    {
        public string remittance { get; set; }
        public int rcode { get; set; }
    }

    public class Correction_Nature
    {
        public string Nature { get; set; }
        public string Ncode { get; set; }
    }

    public class Correction_Country
    {
        public string Country { get; set; }
        public int Ccode { get; set; }
    }

    public class Correction_Section
    {
        public string Section { get; set; }
    ...
    public class Correction_Dropdowns
    {
        public string Form { get; set; }
        public List<Correction_Remiitance> list_Correction_Remiitance { get; set; }
        public List<Correction_Nature> list_Correction_Nature { get; set; }
        public List<Correction_Country> list_Correction_Country { get; set; }
        public List<Correction_Section> list_Correction_Section { get; set; }
    }

    public class tbl_Allowance
    {
        public int? Employee_ID { get; set; }
        ...
        public string AllownaceKey { set; get; }
    }
    ...
    public class VoucChallWithRetuDeta
    {
        public double VouchersOrDeductions { get; set; }
    ...
    public class Deduction
    {
        ...
        public bool IsNRI { get; set; }
        public string FormType { get; set; }
        public bool ThresholdLimit { get; set; }
        public string Quarter { get; set; }
        public int CPaid { get; set; }
        public int DeducteeId { get; set; }
        public int NatureId { get; set; }
        public string NatureSubId { get; set; }
        ...
        public float SurchargeAmt { get; set; }
        public float ECessAmt { get; set; }
        ...
        public int UVCCA { get; set; }
        public string RToken { get; set; }
        public string Nri27EQ { get; set; }
        public string EstbInIndia { get; set; }
        public string ChlDtls { get; set; }
        public string BAC1A { get; set; }
        public int Cid { get; set; }
        public string Returnstatus { get; set; }
        ...
        public int ChallanId { get; set; }
        public string ChallanDate { get; set; }
        public string ChallanBankNo { get; set; }
        public string DeductedDate { get; set; }
    }

    public class FileMailing
    {
    ...
    public class CompanyMasterList_VM
    {
        public int Company_ID { get; set; }
        public string CompanyName { get; set; }
        public string TANNo { get; set; }
        public string PANNo { get; set; }
        public string TracesUserName { get; set; }
